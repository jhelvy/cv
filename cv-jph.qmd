...
**Total**: `r scales::dollar(sum(grants_ex_pi$budget_total))`; **Helveston Portion**: `r scales::dollar(sum(grants_ex_pi$budget_jph))`
...
**Total**: `r scales::dollar(sum(grants_ex_copi$budget_total))`; **Helveston Portion**: `r scales::dollar(sum(grants_ex_copi$budget_jph))`
...
**Total**: `r scales::dollar(sum(grants_affiliated$budget_total))`
...
**Total**: `r scales::dollar(sum(grants_internal$budget_total))`
...
_Note on author order: In my field, it is conventional that the last author denotes intellectual direction by the senior author when student(s) advised by the senior author are engaged on the study. On non–student papers, authorship effort is denoted in standard order_.
