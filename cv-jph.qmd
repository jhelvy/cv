...
The convention in my field is that the last author denotes intellectual direction by the senior author when student(s) advised by the senior author are engaged on the study. On non–student papers, authorship effort is denoted in standard order.
